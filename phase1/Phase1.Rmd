...
Dies liefert uns einen Ordner build mit folgender Struktur:
    ...
    build
        <FQBN des Board, jedoch mit . Anstatt : als Trennzeichen>
            ...
            - <Sketchname>.ino.with_bootloader.bin (Kompilierter Arduino Sketch im ELF mit Bootloader Binärformat)
            - <Sketchname>.ino.with_bootloader.hex (Kompilierter Arduino Sketch im ELF mit Bootloader Hexformat)
