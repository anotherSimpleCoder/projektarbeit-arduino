...
##### 2.3.1 Ermitteln des Vollständig quanitifierten Platinennamens
...
Um ein Projekt mit der Arduino CLI und der Wokwi Extension aufzustezen muss eine andere Projektstruktur verwendet werden. Um hier Einrichtungshürden zu umgehen, wird ein <a href="https://github.com/anotherSimpleCoder/projektarbeit-arduino/blob/main/phase1/scaffold.sh">Bash Skript</a> zur Verfügung gestellt. 
